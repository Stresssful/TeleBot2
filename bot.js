...
setInterval(intervalFunc, 900000);// Перевірка наявності оновлень (900000 - 15 хв, 3600000 - 1 год)
  ...
  function getReplacements(GROUP, callback)
  {
    ...
    bot.onText(/\/start/, function(msg, match) { //команда \start
      let fromId = msg.from.id;
      let text='Привіт! Я бот, який може відслідковувати заміни для студентів ХПК. Просто напиши мені назву групи про заміни якої ти хочеш дізнатись.';
      text+='\n\n';
      text+='Якщо ти просто хочеш переглянути заміни на цю групу, натисни кнопку "Переглянути заміни".';
      text+='\n\n';
      text+='Якщо ж ти хочеш отримувати повідомлення кожен раз коли на сайті ХПК виходять заміни, натисни на кнопку "Відслідковувати групу".';
      text+='\n\n';
      text+='Також, у мене є деякі команди:\n/my - Переглянути мої заміни;\n/remove - Не відслідковувати групу;\n/help - Переглянути це повідомлення з інструкцією.';
